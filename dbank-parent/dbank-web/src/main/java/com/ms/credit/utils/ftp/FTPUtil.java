package com.ms.credit.utils.ftp;
...
public class FTPUtil {
    ...
    public List<File> download() {
        ...
        try {
            ...
            boolean changeWorkingDirectory = client.changeWorkingDirectory(remoteDir);
            logger.info("切换至工作目录【" + remoteDir + "】");
            if (changeWorkingDirectory) {
                // 2、读取远程文件
                ftpFiles = client.listFiles(regEx);
