...
!function (e, t) {
    ...
    return function (e) {
                ...
                key: "_initPlugin", value: function (e) {
                    ...
                    e.trigger("init"), e.trigger("renderTab", function (o) {
                        ...
                        if (t)for (var o = v["default"].one(".vc-tool-last"), n = function (n) {
                            var l = t[n], i = v["default"].render(x["default"], {
                                name: l.name || "Undefined",
                                pluginID: e.id
                            });
        ...
        t.getDate = o, t.isNumber = n, t.isString = l, t.isArray = i, t.isBoolean = r, t.isUndefined = a, t.isNull = c, t.isSymbol = s, t.isObject = d, t.isFunction = u, t.isElement = v, t.isWindow = f, t.isPlainObject = p, t.htmlEncode = b, t.JSONStringify = g, t.getObjAllKeys = h, t.getObjName = m, t.setStorage = y, t.getStorage = _
    }, function (e, t, o) {
        "use strict";
        function n(e) {
            return e && e.__esModule ? e : {"default": e}
        ...
        "use strict";
        function o(e, t, o) {
            var n = /\{\{([^\}]+)\}\}/g, l = "", i = "", r = 0, a = [], c = function (e, t) {
                "" !== e && (l += t ? e.match(/^ ?else/g) ? "} " + e + " {\n" : e.match(/\/(if|for|switch)/g) ? "}\n" : e.match(/^ ?if|for|switch/g) ? e + " {\n" : e.match(/^ ?(break|continue) ?$/g) ? e + ";\n" : e.match(/^ ?(case|default)/g) ? e + ":\n" : "arr.push(" + e + ");\n" : 'arr.push("' + e.replace(/"/g, '\\"') + '");\n')
            };
            for (window.__mito_data = t, window.__mito_code = "", window.__mito_result = "", e = e.replace(/(\{\{ ?switch(.+?)\}\})[\r\n\t ]+\{\{/g, "$1{{"), e = e.replace(/^\n/, "").replace(/\n/g, "\\\n"), i = "(function(){\n", l = "var arr = [];\n"; a = n.exec(e);)c(e.slice(r, a.index), !1), c(a[1], !0), r = a.index + a[0].length;
            c(e.substr(r, e.length - r), !1), l += '__mito_result = arr.join("");', l = "with (__mito_data) {\n" + l + "\n}", i += l, i += "})();";
            var s = document.createElement("SCRIPT");
            s.innerHTML = i, document.documentElement.appendChild(s);
            var d = __mito_result;
            if (document.documentElement.removeChild(s), !o) {
                var u = document.createElement("div");
                u.innerHTML = d, d = u.children[0]
            }
            return d
        }
        ...
        var c = function () {
            ...
            if (void 0 === n) {
                ...
                return null === l ? void 0 : w(l, t, o)
            }
            if ("value"in n)return n.value;
            var i = n.get;
            if (void 0 !== i)return i.call(o)
        }, d = o(4), u = l(d), v = o(3), f = n(v), p = o(17), b = l(p), g = o(21), h = l(g), m = o(22), y = l(m), _ = function (e) {
            function t() {
                var e;
                i(this, t);
                ...
                return a.tplTabbox = h["default"], a.windowOnError = null, a
            }
            ...
            return a(t, e), c(t, [{
                key: "onReady", value: function () {
                    ...
                    n.innerHTML = o, document.documentElement.appendChild(n), document.documentElement.removeChild(n)
                }
            }, {
                key: "mockConsole", value: function () {
                    s(Object.getPrototypeOf(t.prototype), "mockConsole", this).call(this);
                    var e = this;
                    f.isFunction(window.onerror) && (this.windowOnError = window.onerror), window.onerror = function (t, o, n, l, i) {
                        var r = t;
                        o && (r += "\n" + o.replace(location.origin, "")), (n || l) && (r += ":" + n + ":" + l), e.printLog({
                            logType: "error",
                            logs: [r],
                            noOrigin: !0
                        }), f.isFunction(e.windowOnError) && e.windowOnError.call(window, t, o, n, l, i)
                    }
                }
            }, {
                key: "evalCommand", value: function (e) {
                    ...
                    o.innerHTML = t, document.documentElement.appendChild(o);
                    var n = window.__vConsole_cmd_result, l = window.__vConsole_cmd_error;
                    if (document.documentElement.removeChild(o), 0 == l) {
                        var i = void 0;
                        f.isArray(n) || f.isObject(n) ? i = this.getFoldedLine(n) : (f.isNull(n) ? n = "null" : f.isUndefined(n) ? n = "undefined" : f.isFunction(n) ? n = "function()" : f.isString(n) && (n = '"' + n + '"'), i = u["default"].render(y["default"], {
                            content: n,
                            type: "output"
                        })), this.printLog({logType: "log", content: i, noMeta: !0, style: ""})
                    } else this.printLog({logType: "error", logs: [n], noMeta: !0, style: ""})
                }
            }]), t
        }(b["default"]);
                    ...
                    if (this.reqList[e] = n, this.isReady) {
                        ...
                        switch (n.responseType) {
                            ...
                            case"text":
                                ...
                                } else i.response = Object.prototype.toString.call(n.response);
                                break;
                            case"json":
                            ...
                            case"arraybuffer":
                            default:
                                i.response = Object.prototype.toString.call(n.response)
                        }
                        ...
                        var a = d["default"].render(_["default"], i), c = this.domList[e];
                        n.status >= 400 && d["default"].addClass(d["default"].one(".vc-group-preview", a), "vc-table-row-error"), c ? c.parentNode.replaceChild(a, c) : d["default"].one(".vc-log", this.$tabbox).insertAdjacentElement("beforeend", a), this.domList[e] = a;
                ...
                key: "mockAjax", value: function () {
                    ...
                    if (e) {
                        ...
                        t._open = o, t._send = n, window.XMLHttpRequest.prototype.open = function () {
                            var e = this, n = [].slice.call(arguments), l = n[0], i = n[1], r = t.getUniqueID();
                            e._requestID = r, e._method = l, e._url = i;
                            var a = e.onreadystatechange || function () {
                                };
                            return e.onreadystatechange = function () {
                                var o = t.reqList[r] || {};
                                if (o.readyState = e.readyState, o.status = e.status, o.responseType = e.responseType, 0 == e.readyState)o.startTime = +new Date; else if (1 == e.readyState)o.startTime = +new Date; else if (2 == e.readyState) {
                                    o.header = {};
                                    for (var n = e.getAllResponseHeaders() || "", l = n.split("\n"), i = 0; i < l.length; i++) {
                                        var c = l[i];
                                        if (c) {
                                            var s = c.split(": "), d = s[0], u = s.slice(1).join(": ");
                                            o.header[d] = u
                                        }
                                    }
                                } else 3 == e.readyState || 4 == e.readyState && (o.endTime = +new Date, o.costTime = o.endTime - (o.startTime || o.endTime), o.response = e.response);
                                return e._noVConsole || t.updateRequest(r, o), a.apply(e, arguments)
                            }, o.apply(e, n)
                        }, window.XMLHttpRequest.prototype.send = function () {
                            var e = this, o = [].slice.call(arguments), l = o[0], i = t.reqList[e._requestID] || {};
                            ...
                            if ("POST" == i.method)if (v.isString(l)) {
                                var b = l.split("&");
                                i.postData = {};
                                var g = !0, h = !1, m = void 0;
                                try {
                                    for (var y, _ = b[Symbol.iterator](); !(g = (y = _.next()).done); g = !0) {
                                        var w = y.value;
                            ...
                            } else v.isPlainObject(l) && (i.postData = l);
        ...
        e.exports = '<dl class=vc-table-row> <dd class="vc-table-col vc-table-col-4">Name {{if (count > 0)}}({{count}}){{/if}}</dd> <dd class=vc-table-col>Method</dd> <dd class=vc-table-col>Status</dd> <dd class=vc-table-col>Time</dd> </dl>'
    }, function (e, t) {
        e.exports = '<div class=vc-group> <dl class="vc-table-row vc-group-preview"> <dd class="vc-table-col vc-table-col-4">{{url}}</dd> <dd class=vc-table-col>{{method}}</dd> <dd class=vc-table-col>{{status}}</dd> <dd class=vc-table-col>{{costTime}}</dd> </dl> <div class=vc-group-detail> <div> <dl class="vc-table-row vc-left-border"> <dt class="vc-table-col vc-table-col-title">Headers</dt> </dl> {{if (header !== null)}} {{for (var key in header)}} <div class="vc-table-row vc-left-border vc-small"> <div class="vc-table-col vc-table-col-2">{{key}}</div> <div class="vc-table-col vc-table-col-4 vc-max-height-line">{{header[key]}}</div> </div> {{/for}} {{else}} <div class="vc-table-row vc-left-border vc-small"> <div class="vc-table-col vc-table-col-2">-</div> </div> {{/if}} </div> {{if (getData !== null)}} <div> <dl class="vc-table-row vc-left-border"> <dt class="vc-table-col vc-table-col-title">Query String Parameters</dt> </dl> {{for (var key in getData)}} <div class="vc-table-row vc-left-border vc-small"> <div class="vc-table-col vc-table-col-2">{{key}}</div> <div class="vc-table-col vc-table-col-4 vc-max-height-line">{{getData[key]}}</div> </div> {{/for}} </div> {{/if}} {{if (postData !== null)}} <div> <dl class="vc-table-row vc-left-border"> <dt class="vc-table-col vc-table-col-title">Form Data</dt> </dl> {{for (var key in postData)}} <div class="vc-table-row vc-left-border vc-small"> <div class="vc-table-col vc-table-col-2">{{key}}</div> <div class="vc-table-col vc-table-col-4 vc-max-height-line">{{postData[key]}}</div> </div> {{/for}} </div> {{/if}} <div> <dl class="vc-table-row vc-left-border"> <dt class="vc-table-col vc-table-col-title">Response</dt> </dl> <div class="vc-table-row vc-left-border vc-small"> <pre class="vc-table-col vc-max-height vc-min-height">{{response || \'\'}}</pre> </div> </div> </div> </div>'
    }])
});